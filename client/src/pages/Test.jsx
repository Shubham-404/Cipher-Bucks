...
import { MakePostRequest, MakeGetRequest } from '../utils/req-backend';

export default function Test() {
  document.title = "KhataBook • Test"

  const { register, handleSubmit, formState: { errors } } = useForm();
  const onSubmit = (data) => {
    // console.log(data);
    MakePostRequest('test1', data)
  }
    ...
    <div className="bg-indigo-500 grid grid-cols-1 md:grid-cols-2 h-[90svh]">
      ...
      <div className="flex items-center justify-center rounded-t-4xl bg-no-repeat bg-[length:auto_50%] bg-bottom bg-[url('/images/undraw_quiet-street.png')] bg-white">
        <div className="flex justify-center items-center min-h-[60vh] px-4">
          ...
          >
            <h1 className="text-2xl font-semibold text-gray-700 text-center">Test 🔐</h1>
